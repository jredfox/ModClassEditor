...
public enum DataType {
	...
	WRAPPED_CHAR("Ljava/lang/Character;", "java/lang/Character", "(C)Ljava/lang/Character;", -1, Opcodes.AASTORE, true, "([Ljava/lang/Character;IC)V", "([Ljava/lang/Character;CIII)V", "([Ljava/lang/Character;[CI)V", "([Ljava/lang/Character;ILjava/lang/Character;)V", "([Ljava/lang/Character;Ljava/lang/Character;III)V", "([Ljava/lang/Character;[Ljava/lang/Character;I)V"),
	WRAPPED_BOOLEAN("Ljava/lang/Boolean;", "java/lang/Boolean", "(Z)Ljava/lang/Boolean;", -1, Opcodes.AASTORE, true, 	"([Ljava/lang/Boolean;IZ)V", "([Ljava/lang/Boolean;ZII)V", "([Ljava/lang/Boolean;[ZI)V", "([Ljava/lang/Boolean;ILjava/lang/Boolean;)V", "([Ljava/lang/Boolean;Ljava/lang/Boolean;II)V", "([Ljava/lang/Boolean;[Ljava/lang/Boolean;I)V"),
	WRAPPED_BYTE("Ljava/lang/Byte;", "java/lang/Byte", "(B)Ljava/lang/Byte;", -1, Opcodes.AASTORE, true, 				"([Ljava/lang/Byte;IB)V", "([Ljava/lang/Byte;BIII)V", "([Ljava/lang/Byte;[BI)V", "([Ljava/lang/Byte;ILjava/lang/Byte;)V", "([Ljava/lang/Byte;Ljava/lang/Byte;III)V", "([Ljava/lang/Byte;[Ljava/lang/Byte;I)V"),
	WRAPPED_SHORT("Ljava/lang/Short;", "java/lang/Short", "(S)Ljava/lang/Short;", -1, Opcodes.AASTORE, true, 			"([Ljava/lang/Short;IS)V", "([Ljava/lang/Short;SIII)V", "([Ljava/lang/Short;[SI)V", "([Ljava/lang/Short;ILjava/lang/Short;)V", "([Ljava/lang/Short;Ljava/lang/Short;III)V", "([Ljava/lang/Short;[Ljava/lang/Short;I)V"),
	WRAPPED_INT("Ljava/lang/Integer;", "java/lang/Integer", "(I)Ljava/lang/Integer;", -1, Opcodes.AASTORE, true, 		"([Ljava/lang/Integer;II)V", "([Ljava/lang/Integer;IIII)V", "([Ljava/lang/Integer;[II)V", "([Ljava/lang/Integer;ILjava/lang/Integer;)V", "([Ljava/lang/Integer;Ljava/lang/Integer;III)V", "([Ljava/lang/Integer;[Ljava/lang/Integer;I)V"),
