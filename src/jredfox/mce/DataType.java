...
public enum DataType {
	...
	WRAPPED_CHAR("Ljava/lang/Character;", "java/lang/Character", "(C)Ljava/lang/Character;", -1, Opcodes.AASTORE, true, "([Ljava/lang/Character;IC)V", "([Ljava/lang/Character;CIII)V", "([Ljava/lang/Character;[CI)V", "([Ljava/lang/Character;ILjava/lang/Character;)V", "([Ljava/lang/Character;Ljava/lang/Character;III)V", ""),
	WRAPPED_BOOLEAN("Ljava/lang/Boolean;", "java/lang/Boolean", "(Z)Ljava/lang/Boolean;", -1, Opcodes.AASTORE, true, 	"([Ljava/lang/Boolean;IZ)V", "([Ljava/lang/Boolean;ZII)V", "([Ljava/lang/Boolean;[ZI)V", "([Ljava/lang/Boolean;ILjava/lang/Boolean;)V", "([Ljava/lang/Boolean;Ljava/lang/Boolean;II)V", ""),
	WRAPPED_BYTE("Ljava/lang/Byte;", "java/lang/Byte", "(B)Ljava/lang/Byte;", -1, Opcodes.AASTORE, true, 				"([Ljava/lang/Byte;IB)V", "([Ljava/lang/Byte;BIII)V", "([Ljava/lang/Byte;[BI)V", "([Ljava/lang/Byte;ILjava/lang/Byte;)V", "([Ljava/lang/Byte;Ljava/lang/Byte;III)V", ""),
	WRAPPED_SHORT("Ljava/lang/Short;", "java/lang/Short", "(S)Ljava/lang/Short;", -1, Opcodes.AASTORE, true, 			"([Ljava/lang/Short;IS)V", "([Ljava/lang/Short;SIII)V", "([Ljava/lang/Short;[SI)V", "([Ljava/lang/Short;ILjava/lang/Short;)V", "([Ljava/lang/Short;Ljava/lang/Short;III)V", ""),
	WRAPPED_INT("Ljava/lang/Integer;", "java/lang/Integer", "(I)Ljava/lang/Integer;", -1, Opcodes.AASTORE, true, 		"([Ljava/lang/Integer;II)V", "([Ljava/lang/Integer;IIII)V", "([Ljava/lang/Integer;[II)V", "([Ljava/lang/Integer;ILjava/lang/Integer;)V", "([Ljava/lang/Integer;Ljava/lang/Integer;III)V", ""),
	WRAPPED_LONG("Ljava/lang/Long;", "java/lang/Long", "(J)Ljava/lang/Long;", -1, Opcodes.AASTORE, true, 				"([Ljava/lang/Long;IJ)V", "([Ljava/lang/Long;JIII)V", "([Ljava/lang/Long;[JI)V", "([Ljava/lang/Long;ILjava/lang/Long;)V", "([Ljava/lang/Long;Ljava/lang/Long;III)V", ""),
	WRAPPED_FLOAT("Ljava/lang/Float;", "java/lang/Float", "(F)Ljava/lang/Float;", -1, Opcodes.AASTORE, true, 			"([Ljava/lang/Float;IF)V", "([Ljava/lang/Float;FIII)V", "([Ljava/lang/Float;[FI)V", "([Ljava/lang/Float;ILjava/lang/Float;)V", "([Ljava/lang/Float;Ljava/lang/Float;III)V", ""),
	WRAPPED_DOUBLE("Ljava/lang/Double;", "java/lang/Double", "(D)Ljava/lang/Double;", -1, Opcodes.AASTORE, true, 		"([Ljava/lang/Double;ID)V", "([Ljava/lang/Double;DIII)V", "([Ljava/lang/Double;[DI)V", "([Ljava/lang/Double;ILjava/lang/Double;)V", "([Ljava/lang/Double;Ljava/lang/Double;III)V", ""),
