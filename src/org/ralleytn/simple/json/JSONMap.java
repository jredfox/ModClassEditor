...
import org.ralleytn.simple.json.internal.NumUtil;
...
public class JSONMap extends LinkedHashMap<Object, Object>{
	...
	{
		return NumUtil.getLong((Number)this.get(key));
	}

	public Integer getInt(Object key)
	{
		return NumUtil.getInt((Number)this.get(key));
	}
	
	public Short getShort(Object key)
	{
		return NumUtil.getShort((Number)this.get(key));
	}
	
	public Byte getByte(Object key)
	{
		return NumUtil.getByte((Number)this.get(key));
	}
	
	public Double getDouble(Object key)
	{
		return NumUtil.getDouble((Number)this.get(key));
	}
	
	public Float getFloat(Object key)
	{
		return NumUtil.getFloat((Number)this.get(key));
	}
